// 8-bit multiplier module for lab 4.5
// Implemnts multiplication without utilizing the  * operator
// (as per the strict laboratory requirements)
//
// HOW IT WORKS:
...
module mult_unit(input [7:0] data1, input [7:0] data2, output reg [7:0] out);
    ...
    // Utilizes a tree struture (pairs first, then pairs of pairs)
