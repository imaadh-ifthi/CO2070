...
//     bne: same as beq = 8 ✓
//   All fit in 8 time units. we're golden.
//
...
//   if all 13 phases work I am buying myself TWO pizzas
...
module cpu_tb;
    ...
    initial begin
        ...
        // (now with 50% more machine code to write. kill me)
        // ============================================================
        ...
        // ============================================================
        // NEW INSTRUCTIONS FOR LAB 4.5 - EXTENDED ISA TESTS
        // (the bonus marks arc begins here)
        // ============================================================
    ...
    initial begin
        ...
        // r1 = 42  (0x2A) - mov'd from r0 in phase 13
        // r2 = 35  (0x23) - mult result (5 * 7)
        ...
        // old program ~30 cycles + new tests ~20 cycles = ~50 cycles at 8 time units = 400
        // adding extra margin because I am paranoid
        #900;
        ...
        $display("r1 = %0d (0x%02h) [expected: 42 (0x2A) - mov'd from r0]", 
                 mycpu.myreg.registers[1], mycpu.myreg.registers[1]);
        $display("r2 = %0d (0x%02h) [expected: 35 (0x23) - mult 5*7]", 
