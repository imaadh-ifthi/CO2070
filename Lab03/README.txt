...
1.  Compile the "CO2070Assembler.c" according to the instructions given in the C  
    file and generate the executable named "CO2070Assembler" (on Linux). Make sure 
    ...
    this only once as long as the Assembler code is kept unchanged.
        ...
        Command: gcc CO2070Assembler.c -o CO2070Assembler
